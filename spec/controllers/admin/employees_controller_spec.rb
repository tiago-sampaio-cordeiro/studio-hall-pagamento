  ...
  def default_params
    {
      user: {
        ...
        admission_date: Faker::Date.between(from: "2024-01-01", to: Date.current).to_s,
        birth_date: Faker::Date.between(from: "1985-01-01", to: "2005-12-31").to_s,
        contract_type: "clt",
        gender: "masculino",
        phone_number: Faker::PhoneNumber.cell_phone,
        position: Faker::Job.position,
        rg: Faker::Number.number(digits: 10).to_s,
